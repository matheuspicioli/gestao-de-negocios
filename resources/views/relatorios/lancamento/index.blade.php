...
@section('title', 'Relatórios lançamento')
...
@section('content_header')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">
            <i class="fas fa-file-pdf"></i> Lançamento</a>
        </li>
    </ol>
@stop
        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Relatório de lançamento</h3>
                    <div class="box-tools pull-right">
                        <a href="{{ route('relatorios.lancamento.gerar') }}" class="btn btn-success btn-xs">
                            PDF
                        </a>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <table id="relatorio-table" class="table table-bordered table-hover dataTable" role="grid">
                                ...
                                <tbody>
                                @foreach($relatorios_lancamento as $relatorio)
                                    <tr>
